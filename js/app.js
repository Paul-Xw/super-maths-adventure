// v6.0.3 cache killer
if(!localStorage.getItem('sma_v603_cache_killer_done')){
  localStorage.setItem('sma_v603_cache_killer_done','1');
...
async function startMission(mode){
  console.log('SMA v6.0.3 startMission',mode,currentWorld.slug);
